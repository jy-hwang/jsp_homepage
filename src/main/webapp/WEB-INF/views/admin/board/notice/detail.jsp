          ...
          <div class="margin-top first">
            ...
            <table class="table">
              <tbody>
                ...
                <tr>
                  <th>작성일</th>
                  <td class="text-align-left text-indent" colspan="3"><fmt:formatDate pattern="yyyy-MM-dd hh:mm:ss" value="${notice.createdDate }" /></td>
                </tr>
                <tr>
                  <th>작성자</th>
...
/
          ...
          <div class="margin-top text-align-center">
            <a class="btn-text btn-cancel" href="list">목록</a> <a class="btn-text btn-default" href="edit">수정</a> <a class="btn-text btn-default" href="del">삭제</a>
          </div>
    ...
    <footer id="footer">
      <div class="content-container">
        ...
        <div id="company-info">
          ...
          <div id="copyright" class="margin-top">Copyright ⓒ newlecture.com 2012-2025 All Right Reserved. Contact admin@newlecture.com for more information</div>
        </div>
      </div>
    </footer>
  </body>
